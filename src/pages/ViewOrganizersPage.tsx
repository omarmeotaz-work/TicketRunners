...
const ViewOrganizersPage: React.FC = () => {
  ...
  const organizer: Organizer = useMemo(
    () => ({
      ...
      description:
        "Sheba Events focuses on bringing authentic Egyptian music experiences to fans around the world. From intimate unplugged sessions to grand arena shows, we curate, promote, and manage live performances with passion and precision.",
      logoUrl:
      ...
      events: [
        ...
        {
          id: "evt-2",
          title: "Oriental Fusion Night",
          images: [{ url: "/event2.jpg", isPrimary: true }],
          date: "April 10, 2025",
          time: "7:30 PM",
          location: "Bibliotheca Alexandrina Open Air Theater",
          rating: 4.6,
          category: "Music",
        },
        {
          id: "evt-3",
          title: "Cairo Ramadan Festival",
